...
<html lang="fr">
	<head>
		...
		<title>Skyincap - Admin Ajouter une actualité</title>
		...
		<div class="section2">
            <div class="u-container">
				<div class="u-top-column-t-long">
					<h1 class="no-margin"> <span class="u-titre-principal-color" data-i18n="ajouter-actualite_i18n"> Ajouter une actualité </span></h1>
					<div class="u-top-text-long">
						<form method="post" action="recap.php" enctype="multipart/form-data">
							<input style="width:100% ; height: 40px; background-color:#EDEDED ;" type="text" name="titreA" placeholder="Titre de l'actualité" required>
							<input style="width:100% ; height: 40px; background-color:#EDEDED ;" type="date" name="date_actu" title="ex : 2023-07-20 (AAAA-MM-DD)" placeholder="Date de l'actualité" required>
							<textarea style='width:100% ; height: 700px; background-color:#EDEDED ;padding-top: 12.5px;font-size: 15px;font-weight: bold;font-family: Gotham, "Helvetica Neue", Helvetica, Arial, "sans-serif"' type="text" name="contenu" required> Contenu de l'article </textarea>
							
							<input name="submit" type="submit" style="width:100% ; color:white;height: 40px; background-color:#4861AD;text-align: left; font-weight: bold; font-size: 15px;" value="Publier l'actu sur le site" >
						</form>
	...
	<div class="section2">
				<div class="u-container">
					<div class="u-top-column-t-long">
						<h1 class="no-margin"> <span class="u-titre-principal-color" data-i18n="erreur-de-connect_i18n"> ERREUR, IL SEMBLE QUE VOUS NE SOYEZ PAS CONNECTÉ</span></h1>
						<div class="u-top-text-long">
								...
								<button style="width:100% ; height: 40px; background-color:#4861AD;" type="submit">
									<a style="color: white;" href="Connexion.php" data-i18n="connect-bouton_i18n"> Connectez-vous en cliquant ici </a>
								</button>
						</div>
					</div>
				</div>
