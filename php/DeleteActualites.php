...
$sqlQuery = 'SELECT IdActu, Titre from actualité';
...
<html lang="fr">
	<head>
		...
		<title>Skyincap - Supprimer une actualité </title>
		...
		<div class="section2">
            <div class="u-container">
				<div class="u-top-column-t-long">
					<h1 class="no-margin"> <span class="u-titre-principal-color" data-i18n="supprimer-actualite_i18n"> Supprimer une actualité </span></h1>
					<div class="u-top-text-long">
						<form method="post" action="recap.php">
							<select name="ActuSupp" style="width:100% ; height: 40px; background-color:white ;">
								<option value="" disabled selected>Selectionner l'actu</option>
                        <?php foreach ($actus as $actu){ ?>   
								<option value="<?php echo $actu['IdActu'];?> / <?php echo $actu['Titre'];?>">#<?php echo $actu['IdActu'];?>,<?php echo $actu['Titre'];?></option>
                        <?php } ?> 
    						</select>
							<input name="envoyer" type="submit" style="width:100% ; color:white;height: 40px; background-color:#4861AD;text-align: left; font-weight: bold; font-size: 15px;" value="Supprimer l'offre du site" >
						</form>
