...
if ( !empty($_POST['MailCo']) && !empty($_POST['mot_passe']) ){
	...
	foreach ($administrateurs as $administrateur){
		...
		if ($administrateur['MailAdmin'] == $mail && crypt($mot_passe, '_J9..rasm') == $administrateur['MDPAdmin']) {
...
<html lang="fr">
	<head>
		...
		<title>Skyincap - Verification de l'action en cours</title>
...
<?php if(isset($_SESSION['LOGGED_USER'])): ?>
					...
					<div class="u-top-column-t-long">
						...
						<div class="u-top-text-long">
								...
								<button style="width:100% ; height: 40px; background-color:#4861AD;" type="submit">
									<a style="color: black;padding-left:10px;" href="connexion.php"> Réessayer </a>
								</button>
						</div>
					</div>
				</div>
	...
	<?php elseif($_SESSION['LOGGED_USER'] != $_SESSION['GARDER']): ?> 
			<div class="section2">
				<div class="u-container">
					<div class="u-top-column-t-long">
						<h1 class="no-margin"> <span class="u-titre-principal-color"> Connexion réussie </span></h1>
						<div class="u-top-text-long">
							<form>
									<button style="width:100% ; height: 40px; background-color:#427c29; padding-left: 10px; margin-bottom:20px;" type="submit">
										<a href="connecté.php"> Aller à l'accueil </a>
									</button>
								</form>
							<div class="echec_bouton" style="width:100% ; height: 150px; color:#000000;	border: 0; margin-bottom: 40px; text-align: left; font-weight: bold; font-size: 15px; ">Bienvenue sur la page d'accueil de notre site administrateur ! Nous sommes ravis de vous accueillir dans cet espace réservé aux gestionnaires et aux administrateurs.<br><br>
								Ici, vous trouverez tous les outils et fonctionnalités nécessaires pour gérer efficacement votre site. Notre interface conviviale et intuitive vous permettra de naviguer facilement à travers les différentes sections et de gérer les utilisateurs, les offres d'emplois ou encore les actualités.<br><br>
								Afin de poursuivre votre navigation, dirigez-vous ver la page d'accueil avec le lien ci-dessus.
							</div>
