...
<!-- Footer -->
<footer class="bg-gray-800 text-white py-8 px-24">
        ...
        <div class="flex justify-between">
            ...
            <div class="w-1/2">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <p class="text-white">55 avenue Maurcie Bourges Maunoury, 31200 Toulouse</p>
                </div>
                <!-- Téléphone -->
                <div class="flex items-center mb-4">
                    <div class="bg-white rounded-full p-2 mr-2">
                    ...
                    <p class="text-white">+3 06 05 04 03 02</p>
                </div>
                <!-- E-mail -->
