...
<html lang="fr">
    ...
    <body class="bg-gray-100 dark:bg-gray-600">
        ...
        <section id="contact" class="mx-32 bg-white dark:bg-gray-900 shadow-lg rounded-lg mb-24">
            <div class="form-container flex flex-col py-16 md:flex-row">
                <div class="place-image-contact w-full md:w-1/2 mb-4 md:mb-0">
                    <div class="image-contact"></div>
                </div>
                <div class="form md:w-1/2 md:pl-8">
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-4">NOUS CONTACTER</h2>
                    <form action="" method="POST" class="space-y-4">
                        <!-- Titre de l'évènement -->
                        <div>
                            <label for="name" class="block text-gray-600 dark:text-white">Titre de l'évènement</label>
                        ...
                        <!-- Adresse mail -->
                        <div>
                            <label for="email" class="block text-gray-600 dark:text-white">Adresse de contact</label>
                        ...
                        <!-- Titre de l'évènement -->
                        <div>
                            <label for="name" class="block text-gray-600 dark:text-white">Lieu de l'événement</label>
                        ...
                        <div>
                            <label for="startDateTime" class="block text-gray-600 dark:text-white">Date Heure début de l'évènement</label>
                        ...
                        <div>
                            <label for="endDateTime" class="block text-gray-600 dark:text-white">Date Heure de fin de l'évènement</label>
                        ...
                        <div>
                            <label for="participants" class="block text-gray-600 dark:text-white">Nombre prévu de participants</label>
                        ...
                        <!-- Domaine -->
                        <div>
                            <label for="domain" class="block text-gray-600 dark:text-white">Domaine</label>
                        ...
                        <!-- Votre besoin -->
                        <div>
                            <label for="needs" class="block text-gray-600 dark:text-white">Votre besoin</label>
                        ...
                        <!-- Bouton Envoyer -->
                        <div>
                            <button type="submit" class="w-full px-4 py-2 bg-blue-500 text-white dark:bg-purple-700 hover:bg-blue-700 rounded-3xl">Envoyer</button>
                        </div>
                    </form>
                </div>
            </div>
